...
final class LoginView: UIView {
    ...
    private lazy var rootStackView: UIStackView = {
        ...
        stackView.spacing = LoginConstants.spacingRootStackView
        return stackView
    }()
    ...
    private lazy var titleStackView: UIStackView = {
        ...
        stackView.spacing = LoginConstants.spacingTitleStackView
        return stackView
    }()
    ...
    private lazy var centreStackView: UIStackView = {
        ...
        stackView.spacing = LoginConstants.spacingCenterStackView
        return stackView
    }()
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            passwordTextField.heightAnchor.constraint(
                equalToConstant: LoginConstants.heightTextField),
            loginTextField.heightAnchor.constraint(
                equalToConstant: LoginConstants.heightTextField),
            loginButton.heightAnchor.constraint(
                equalToConstant: LoginConstants.heightButton),
            
            registrButton.bottomAnchor.constraint(
                equalTo: safeAreaLayoutGuide.bottomAnchor,
                constant: -LoginConstants.indentsFromSafeArea),
            registrButton.leadingAnchor.constraint(
                equalTo: safeAreaLayoutGuide.leadingAnchor,
                constant: LoginConstants.indentsFromSafeArea),
            registrButton.trailingAnchor.constraint(
                equalTo: safeAreaLayoutGuide.trailingAnchor,
                constant: -LoginConstants.indentsFromSafeArea)
        ])
